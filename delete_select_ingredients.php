...
<p>
	...
	?>
	<form method = "post" action = "delete_ingredients.php">
       <h3>Select Ingredients to delete from: <input type="submit" value="Click to Delete Ingredients"></h3>
	<table border="1">
        ...
        <script type="text/javascript">
			...
			function addList(value,num){
				...
				newElement.innerHTML = '<td><input id="ing' + num + '" type="button" value="' + value + 
